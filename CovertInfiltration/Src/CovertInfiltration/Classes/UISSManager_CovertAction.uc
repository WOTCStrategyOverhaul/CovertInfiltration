...
simulated protected function ApplyDeterrenceToRisks()
{
	...
	`log("CI: Deterrence is " $ string(SquadDeterrence));

	for (i = 0; i < CovertAction.Risks.Length; i++)
	{
		CovertAction.Risks[i].ChanceToOccurModifier -= SquadDeterrence;
	}
}
